...
\begin{enumerate}
\item $W_0 = 0$ (see figure above).
\item $W$ is made of stationary and independent increments.
\item $W_t - W_s$ is normally distributed with mean 0 and variance $$t-s$$, for $$0\leq s<t$$,
\end{anumerate}
