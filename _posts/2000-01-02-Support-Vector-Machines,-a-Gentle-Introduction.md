...
Such kernel is necessarily **positive definite**. Thanks to the<a target="_blank" href='https://en.wikipedia.org/wiki/Reproducing_kernel_Hilbert_space#Moore.E2.80.93Aronszajn_theorem'> Moore-Aronszajn</a> theorem, every positive definite kernel is a reproducing kernel. To summarize:
